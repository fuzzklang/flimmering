...
ELEM_MINSIZE = 0.7
ELEM_MAXSIZE = 0.71
N = 4      # Number of images for each shape/color combination.
EXPORT_FILENAME = "010"
AMP = 0.25
MAPPING_KEY = "color"
...
shape_original_seq =  [SHAPE for i in range(N_EVENTS)]

r, g, b = "R", "G", "B"
color_original_seq = [[r, g, b][random.randint(0, 2)] for i in range(N_EVENTS)]
...
duration_seq[-1] = MIN_VAL * MUL_SET[1]
